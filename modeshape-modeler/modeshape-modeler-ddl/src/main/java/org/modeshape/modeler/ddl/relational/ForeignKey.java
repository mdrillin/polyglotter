...
/**
 * ForeignKey
 * The relational foreign key class
 */
public class ForeignKey extends RelationalObject {    
    ForeignKey(IObjectDelegate modelObject) {
		super(modelObject);
	}
    ...
    public String getTableRef() {
    	Object propValue = this.delegate.getPropertyValue(TeiidDdlLexicon.Constraint.TABLE_REFERENCE);
     ...
     * @return columns
     */
    public List<String> getColumnRefs() {
    	Object[] refs = this.delegate.getPropertyValues(TeiidDdlLexicon.Constraint.REFERENCES);
    	List<String> colRefs = new ArrayList<String>(refs.length);
    	for(Object ref : refs) {
	...
	public Map<String, Object> getProperties() {
    	...
    	String[] propKeys = RelationalConstants.FOREIGN_KEY_PROP_KEYS.toArray();
    	for(int i=0; i<propKeys.length; i++) {
    		props.put(propKeys[i], getPropertyValue(propKeys[i]));
    	}
    	
//    	props.put(RelationalConstants.FOREIGN_KEY_PROP_KEYS.FOREIGN_KEY_MULTIPLICITY, getPropertyValue(RelationalConstants.FOREIGN_KEY_PROP_KEYS.FOREIGN_KEY_MULTIPLICITY));
//    	props.put(RelationalConstants.FOREIGN_KEY_PROP_KEYS.PRIMARY_KEY_MULTIPLICITY, getPropertyValue(RelationalConstants.FOREIGN_KEY_PROP_KEYS.PRIMARY_KEY_MULTIPLICITY));
//    	props.put(RelationalConstants.FOREIGN_KEY_PROP_KEYS.UNIQUE_KEY_NAME, getPropertyValue(RelationalConstants.FOREIGN_KEY_PROP_KEYS.UNIQUE_KEY_NAME));
//    	props.put(RelationalConstants.FOREIGN_KEY_PROP_KEYS.UNIQUE_KEY_TABLE_NAME, getPropertyValue(RelationalConstants.FOREIGN_KEY_PROP_KEYS.UNIQUE_KEY_TABLE_NAME));
