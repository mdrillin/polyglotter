...
public class Index extends RelationalObject {
    ...
    Index(IObjectDelegate modelObject) {
		super(modelObject);
	}
...
//    	props.put(RelationalConstants.INDEX_PROP_KEYS.AUTO_UPDATE, getPropertyValue(RelationalConstants.INDEX_PROP_KEYS.AUTO_UPDATE));
//    	props.put(RelationalConstants.INDEX_PROP_KEYS.FILTER_CONDITION, getPropertyValue(RelationalConstants.INDEX_PROP_KEYS.FILTER_CONDITION));
